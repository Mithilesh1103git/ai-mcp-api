...
#### Note: By default, the port must be 8080 for API server to discover it. You can use different port by changing environment variable in the .env file, if wanted.
